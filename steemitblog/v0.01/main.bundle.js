...
var MATERIAL_MODULES = [
    ...
    __WEBPACK_IMPORTED_MODULE_7__angular_material__["k" /* MatListModule */], __WEBPACK_IMPORTED_MODULE_7__angular_material__["l" /* MatMenuModule */], __WEBPACK_IMPORTED_MODULE_7__angular_material__["x" /* MatTooltipModule */],
    __WEBPACK_IMPORTED_MODULE_7__angular_material__["s" /* MatSlideToggleModule */], __WEBPACK_IMPORTED_MODULE_7__angular_material__["j" /* MatInputModule */], __WEBPACK_IMPORTED_MODULE_7__angular_material__["d" /* MatCheckboxModule */],
    __WEBPACK_IMPORTED_MODULE_7__angular_material__["w" /* MatToolbarModule */], __WEBPACK_IMPORTED_MODULE_7__angular_material__["t" /* MatSnackBarModule */], __WEBPACK_IMPORTED_MODULE_7__angular_material__["r" /* MatSidenavModule */],
    __WEBPACK_IMPORTED_MODULE_7__angular_material__["v" /* MatTabsModule */], __WEBPACK_IMPORTED_MODULE_7__angular_material__["q" /* MatSelectModule */], __WEBPACK_IMPORTED_MODULE_7__angular_material__["p" /* MatRadioModule */],
    ...
    __WEBPACK_IMPORTED_MODULE_7__angular_material__["f" /* MatDialogModule */], __WEBPACK_IMPORTED_MODULE_7__angular_material__["h" /* MatGridListModule */], __WEBPACK_IMPORTED_MODULE_7__angular_material__["u" /* MatTableModule */], __WEBPACK_IMPORTED_MODULE_7__angular_material__["m" /* MatPaginatorModule */],
    __WEBPACK_IMPORTED_MODULE_7__angular_material__["n" /* MatProgressBarModule */], __WEBPACK_IMPORTED_MODULE_7__angular_material__["o" /* MatProgressSpinnerModule */]
];
...
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent.prototype.searchID = function (searchWord) {
        ...
        SearchComponent_1.getNextPosts(searchWord, null, this.postList, 10, this.tagList, this.keys, this.loading);
        // console.log('---------------------');
    ...
    SearchComponent.getNextPosts = function (author, startPermlink, list, size, tagList, keys, ll) {
        ...
        __WEBPACK_IMPORTED_MODULE_1_steem__["api"].getDiscussionsByAuthorBeforeDateAsync(author, startPermlink, new Date().toISOString().split('.')[0], size, function (err, result) {
            ...
            if (result.length >= size) {
                ...
                SearchComponent_1.getNextPosts(author, lastPermlink, list, size, tagList, keys, ll);
            }
            else {
                for (var indexI = 0; indexI < list.length; ++indexI) {
                    // console.log(list[indexI]);
                ...
                SearchComponent_1.sortTag(list, tagList, keys, ll);
            }
        });
    };
    SearchComponent.sortTag = function (list, tagList, keys, ll) {
        var post = null;
