...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ngrx_store__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__actions_actions__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_ng_actions_actions__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_steem__ = __webpack_require__(266);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_storage__ = __webpack_require__(326);
...
var HomePage = (function () {
    function HomePage(navCtrl, postStore, authorStore, selectStore, getEndStore, loadingCtrl, alertCtrl, storage) {
    ...
    HomePage.prototype.ngAfterContentInit = function () {
        // this.storage.set('histories', ['asinayo']);
        var _this = this;
        // const _this = this;
        this.storage.get('histories').then(function (val) {
            if (val == null) {
                _this.storage.set('histories', []);
                _this.histories = [];
            }
            else {
                _this.histories = val;
    ...
    HomePage.prototype.searchID = function (searchWord) {
        ...
        for (var ii = 0; ii < this.histories.length; ++ii) {
            if (this.histories[ii].user == searchWord) {
        ...
        this.storage.set('histories', this.histories);
        HomePage_1.ll = true;
    ...
    HomePage.getNextPosts2 = function (author, startPermlink, pi) {
        ...
        __WEBPACK_IMPORTED_MODULE_6_steem__["api"].getDiscussionsByAuthorBeforeDateAsync(author, startPermlink, HomePage_1.DATE, HomePage_1.GET_SIZE, function (err, result) {
            ...
            if (result.length >= HomePage_1.GET_SIZE) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_ng_actions_actions__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_commons_SearchUtil__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_steem__ = __webpack_require__(266);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_steem___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_steem__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__catch_select_catch_select__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_showdown__ = __webpack_require__(614);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_showdown___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_showdown__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CatchPage = (function () {
    function CatchPage(navCtrl, navParams, postStore, selectStore, modetore, alertCtrl, modalCtrl) {
        // If we navigated to this page, we will have an item available as a nav param
        // this.selectedItem = navParams.get('item');
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        ...
        this.converter = new __WEBPACK_IMPORTED_MODULE_9_showdown___default.a.Converter();
        this.searchWord = '';
        if (this.postStore == null || this.postStore == undefined) {
            postStore = this.navParams.get('postStore');
            selectStore = this.navParams.get('selectStore');
    ...
    CatchPage.prototype.filterCatch = function (posts) {
        ...
        posts[0].tagMap.forEach(function (value, key) {
            ...
            for (var i = 0; i < value.length; ++i) {
                var post = value[i];
                // let aFIdx = post.body.indexOf('"정답:');
                // if(aFIdx < 0) {
                //   continue;
                // }
                // let aLIdx = post.body.indexOf('"', '"정답:'.length + aFIdx);
                // let answer: string = post.body.substring(aFIdx + '"정답:'.length, aLIdx);
                // let rFIdx = post.body.indexOf('"정답자:', aLIdx);
                // if(rFIdx < 0) {
                //   continue;
                // }
                // let rLIdx = post.body.indexOf('"', '"정답자:'.length + rFIdx);
                // let ra: string = post.body.substring(rFIdx + '"정답자:'.length, rLIdx);
                // posts[0].catchMap.set(post.permlink, {answer:answer.trim(), righter:ra.trim(), post: post});
                posts[0].catchMap.set(post.permlink, { answer: null, righter: null, post: post });
    ...
    CatchPage.prototype.viewAnswer = function (catchInfo) {
        ...
        if (this.replyMap.has(catchInfo.post.permlink)) {
            var ri = this.replyMap.get(catchInfo.post.permlink);
            var profileModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_8__catch_select_catch_select__["a" /* CatchSelectPage */], { list: ri.result, cmtList: ri.cmtList, modalCtrl: this.modalCtrl });
            profileModal.present();
            return;
        }
        console.log('get comments');
        var cmtList = new Array();
        this.getComments(catchInfo.post.author, catchInfo.post.permlink, cmtList);
    };
    ...
    CatchPage.prototype.showAlertAnswerAndRighter = function (msg, ra) {
        var alert = this.alertCtrl.create({
            title: '정답자 - ' + ra,
            subTitle: msg,
            buttons: ['헐?']
    ...
    CatchPage.prototype.getComments = function (id, permlink, cmtList) {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_7_steem__["api"].getContentReplies(id, permlink, function (err, result) {
            if (err != null) {
                return;
            }
            _this.pickAnswer(result, cmtList);
            cmtList.sort(function (a, b) {
            ...
            // for (let iii = 0 ; iii < cmtList.length; ++iii) {
            //   console.log(cmtList[iii].author + ' - ' +cmtList[iii].body);
            // }
            _this.replyMap.set(permlink, { result: result, cmtList: cmtList });
            var profileModal = _this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_8__catch_select_catch_select__["a" /* CatchSelectPage */], { list: result, cmtList: cmtList, modalCtrl: _this.modalCtrl });
            profileModal.present();
            // _this.showAlertAnswerAndRighter(cmtList[0].body, cmtList[0].author);
        });
    };
    CatchPage.prototype.pickAnswer = function (result, cmtList) {
        var idx = 3;
        do {
            --idx;
            for (var i = 0; i < result.length; ++i) {
                ...
                cmt.body = this.converter.makeHtml(cmt.body);
                if (cmt.children < idx) {
                    continue;
                }
                cmtList.push(cmt);
                // console.log(cmt.author + ' - ' +cmt.body);
            }
        } while (cmtList.length <= 0);
    };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CatchSelectPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var CatchSelectPage = (function () {
    function CatchSelectPage(params, viewCtrl, alertCtrl) {
        this.viewCtrl = viewCtrl;
        this.alertCtrl = alertCtrl;
        this.list = params.get('list');
        this.cmtList = params.get('cmtList');
        this.modalCtrl = params.get('modalCtrl');
    }
    CatchSelectPage.prototype.dismiss = function () {
        this.viewCtrl.dismiss();
    };
    CatchSelectPage.prototype.selectAnswer = function (post) {
        // console.log(post.body);
        if (post.permlink == this.cmtList[0].permlink) {
            this.showAlertAnswerSuccess();
        }
        else {
            this.showAlertAnswerFail();
        }
    };
    CatchSelectPage.prototype.optionSelected = function (event) {
    };
    CatchSelectPage.prototype.onCancel = function (event) {
        // console.log('-=-=-=-=onCancel=-=-=-=-=-=');
        // console.log(event);
    };
    CatchSelectPage.prototype.ngAfterContentInit = function () {
    };
    CatchSelectPage.prototype.getItems = function (ev) {
    };
    CatchSelectPage.prototype.viewAnswer = function (catchInfo) {
    };
    CatchSelectPage.prototype.showAlertAnswerSuccess = function () {
        var alert = this.alertCtrl.create({
            title: '축하합니다.',
            subTitle: '정답입니다!',
            buttons: ['나이쓰']
    ...
    CatchSelectPage.prototype.showAlertAnswerFail = function () {
        var alert = this.alertCtrl.create({
            title: '오답',
            subTitle: '좀 더 생각해보세요',
            buttons: ['응']
    ...
    CatchSelectPage.prototype.showAlertAnswerAndRighter = function (msg, ra) {
        var alert = this.alertCtrl.create({
            title: '정답자 - ' + ra,
            subTitle: msg,
            buttons: ['헐?']
    ...
    CatchSelectPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'catch-select-card',template:/*ion-inline-start:"D:\project\vscode\steemit\sibba\src\pages\catch-select\catch-select.html"*/'<ion-header>\n\n        <ion-toolbar>\n\n                <ion-title>\n\n                  Description\n\n                </ion-title>\n\n                <ion-buttons start>\n\n                  <button ion-button (click)="dismiss()">\n\n                    \n\n                    <ion-icon name="md-close" ></ion-icon>\n\n                  </button>\n\n                </ion-buttons>\n\n              </ion-toolbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n    <ion-list>\n\n\n\n        <ion-card  *ngFor="let dd of list" (click)="selectAnswer(dd)">\n\n\n\n            <ion-card-header>\n\n                {{dd.author}}\n\n            </ion-card-header>\n\n          \n\n            <ion-card-content>\n\n                <div [innerHtml]="dd.body"></div>\n\n            </ion-card-content>\n\n          \n\n          </ion-card>\n\n\n\n        <!-- <button menuClose ion-item  *ngFor="let dd of list" (click)="selectAnswer(dd)">\n\n            {{dd.author}} - {{dd.body}}\n\n        </button> -->\n\n    </ion-list>\n\n</ion-content>'/*ion-inline-end:"D:\project\vscode\steemit\sibba\src\pages\catch-select\catch-select.html"*/,
            styleUrls: ['/src/pages/catch-select/catch-select.scss']
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ViewController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
    ], CatchSelectPage);
    return CatchSelectPage;
}());

//# sourceMappingURL=catch-select.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ng_reducers_reducers__ = __webpack_require__(615);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_card_card__ = __webpack_require__(330);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_real_card_real_card__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_music_music__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_catch_catch__ = __webpack_require__(333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ionic_storage__ = __webpack_require__(326);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_catch_select_catch_select__ = __webpack_require__(334);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_13__pages_catch_catch__["a" /* CatchPage */],
                __WEBPACK_IMPORTED_MODULE_15__pages_catch_select_catch_select__["a" /* CatchSelectPage */]
            ],
            imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ng_reducers_getend_reducer__ = __webpack_require__(328);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ng_reducers_mode_reducer__ = __webpack_require__(329);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ng_actions_actions__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_card_card__ = __webpack_require__(330);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_real_card_real_card__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_music_music__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__app_commons_SearchUtil__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_catch_catch__ = __webpack_require__(333);
...
function searchWordsList(words, tempList) {
    ...
    tl[0].tagMap.forEach(function (value, key) {
        ...
        for (var i = 0; i < value.length; ++i) {
            ...
            for (var j = 0; j < words.length; ++j) {
                ...
                if (post.root_title.indexOf(words[j]) >= 0) {
                    searcharr.push(post);
                    break;
                }
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__getend_reducer__ = __webpack_require__(328);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mode_reducer__ = __webpack_require__(329);
